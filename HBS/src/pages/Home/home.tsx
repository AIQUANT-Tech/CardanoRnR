    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-2xl">
            Experience luxury redefined with breathtaking views and world-class
            hospitality
          </p>
          <button
            onClick={() => navigate("/seebooking")}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
          Discover unparalleled luxury and comfort with our exclusive amenities
          and services
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
            ...
            <p className="text-gray-600">
              Award-winning restaurants serving international cuisine crafted by
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
            ...
            <p className="text-gray-600">
              Rejuvenate your mind and body with our premium spa treatments and
              wellness facilities
            </p>
          </div>
        </div>
