...
5. API Design Document: https://github.com/AIQUANT-Tech/CardanoRnR/tree/main/server/Published_API_Design_Doc
## Installation
...
Create Database DB_CNN
Create a Collection
Connect MongoDB Remotely
The Database DB_CNN provide it in the place of "your-database-connection-string" in DB_CNN

MNEMONIC --
Choose a Cardano Wallet
Install the Wallet
Launch the Wallet & Create a New Wallet
Automatic Seed Phrase Generation
Record and Store Your Seed Phrase (Including Storing in a Text File)
Confirm Your Seed Phrase
Finalize Wallet Setup
Give the Seed Phrase in the place of "your-mnemonic-phrase" in the MNEMONIC

BLOCKFROST_KEY --
Visit the Blockfrost Website
...
Your API Key be in place of the "your-blockfrost-key" in BLOCKFROST_KEY.
...
RECIPIENT_ADD="addr_test1qprv7szf5h6q2g4r9jscx8v4r6r5xuwqkj3wxyz0f8jl4jgx0ud9m5nzxzg"
AMMOUNT_ADA=1000
AMMOUNT=10
...
PLUTUS_SCRIPT_PATH="/home/aiquant/Desktop/git/CardanoRnR/CardanoRnR/SmartContract/Review/ReviewContractV2.plutus"
