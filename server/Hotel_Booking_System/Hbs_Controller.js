...
export const processGuestBookingInfo = async (req, res) => {
    try {
        ...
        for (const guestData of guest_booking_info_rq.guest_list) {
            const { guest_id, first_name, last_name, email, phone_number, booking_id, room_id, room_type, check_in_date, check_out_date, booking_status, total_amount, payment_status } = guestData;
        ...
        res.status(201).json({ message: "Guest and booking data processed successfully" });
