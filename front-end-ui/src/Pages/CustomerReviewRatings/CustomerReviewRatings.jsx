      ...
      >
        ...
        >
          ...
          >
            ...
            <TableContainer
              component={Paper}
              sx={{ margin: 0, paddingRight: "2px", width: "100%", height: "auto" }}
            >
              <Table sx={{ tableLayout: "fixed", width: "100%", height: "auto" }}>
                <TableHead>
                  <TableRow>
                    <TableCell
                      align="center"
                      sx={{ width: "142px", padding: "8px", whiteSpace: "nowrap" }}
                    >
                      Customer Name
                    </TableCell>
                    <TableCell
                      align="center"
                      sx={{ width: "100px", padding: "8px", whiteSpace: "nowrap" }}
                    >
                      Rating
                    </TableCell>
                    <TableCell
                      align="center"
                      sx={{ width: "auto", padding: "8px", textAlign: "center" }}
                    >
                      Review
                    </TableCell>
                    <TableCell
