...
const CustomerReviewManagement = () => {
  ...
  // Whenever sortBy, filterStatus, or debouncedSearchQuery changes, reset page and fetch reviews.
  useEffect(() => {
    setCurrentPage(1);
    fetchReviews();
    ...
    <Box display="flex" width="100vw" height="100vh" bgcolor="white">
      ...
      >
        ...
        >
          ...
          >
            {/* Search Field */}
            <Box mb={6} sx={{ margin: 0, paddingTop: "16px", width: "40%" }}>
              <Autocomplete
                freeSolo
                options={reviews.map((review) => review.user_display_name)}
                value={searchQuery}
