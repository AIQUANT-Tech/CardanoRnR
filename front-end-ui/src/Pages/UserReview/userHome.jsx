...
const ReviewsPage = () => {
    ...
    const { reputation_score, category_wise_review_rating, review_rating_details_overall } = data;

    // Calculate Guest Overall Rating
    const guestOverallRating =
        review_rating_details_overall &&
            review_rating_details_overall.length > 0
            ? (
                review_rating_details_overall.reduce((sum, review) => sum + review.rating, 0) /
